...
$response = api('eigenaars/' . $_GET['id']);
$response2 = api('eigenaars/' . $_GET['id'] . '/dieren');

$naam = $response->{'voornaam'} . ' ';
if (!empty($response->{'tussenvoegsel'})) {
    $naam .= $response->{'tussenvoegsel'} . ' ';
}
$naam .= $response->{'achternaam'};
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <h2 style="text-align: center"><? echo $naam ?></h2>
