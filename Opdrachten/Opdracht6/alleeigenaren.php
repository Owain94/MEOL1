...
<body>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        ...
                        <hr class="small">
                        <span class="subheading">Alle eigenaren.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <a href="eigenaartoevoegen.php">Eigenaar toevoegen</a>

                <h2 style="text-align: center">Alle eigenaren</h2>
                ...
                <table class="table sortable">
                    ...
                    ?>
                        <tr>
                            <td>
                                <? echo '<a href="eigenaar.php?id=' . $info->{'id'} . '">' . $info->{'id'} . '</a>' ?>
                            </td>
                            <td>
                                <? echo '<a href="eigenaar.php?id=' . $info->{'id'} . '">';
                                   echo $info->{'voornaam'} . ' ';
